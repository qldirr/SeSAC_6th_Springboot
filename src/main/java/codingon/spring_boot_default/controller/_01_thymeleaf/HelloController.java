...
//        model.addAttribute("msg", "Hi~");
        ...
        model.addAttribute("imgSrc", "dog2.jpg");
    ...
    public String getPractice1(Model model) {
        model.addAttribute("age", "25");
        Person person1 = new Person(10,"kim");
        Person person2 = new Person(20,"lee");
        Person person3 = new Person(30,"hong");
        Person person4 = new Person(40,"park");
